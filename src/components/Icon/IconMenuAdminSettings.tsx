...
interface IconMenuAdminSettingsProps {
    className?: string;
    fill?: boolean;
    duotone?: boolean;
}

const IconMenuAdminSettings: FC<IconMenuAdminSettingsProps> = ({ className, fill = false, duotone = true }) => {
    return (
        <>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                    opacity="0.5"
                    d="M17.2607 8.3673C18.1738 8.3673 18.914 7.63012 18.914 6.72076C18.914 5.8114 18.1738 5.07422 17.2607 5.07422C16.3476 5.07422 15.6074 5.8114 15.6074 6.72076C15.6074 7.63012 16.3476 8.3673 17.2607 8.3673Z"
                    stroke="#1C274C"
                    stroke-width="1.5"
                />
                <path
...
export default IconMenuAdminSettings;
