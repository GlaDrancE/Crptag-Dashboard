      ...
      <div>
              ...
              <div className='flex ml-[1%] mr-[1%] w-[98%] grow justify-between'>
                <div className="flex flex-col w-[49%] h-full">
                  <div className={`border rounded h-10 w-full flex relative items-center ${fieldsEmpty.username ? 'border-red-500' : 'border-gray-300'} focus-within:border-blue-500`}>
                  ...
                  <div className={`mt-[5%] border rounded h-10 w-full flex relative items-center ${fieldsEmpty.companyName ? 'border-red-500' : 'border-gray-300'} focus-within:border-blue-500`}>
                    <div className="bg-gray-100 h-full">
                  ...
                  <div className={`mt-[5%] border rounded h-10 w-full flex relative items-center ${fieldsEmpty.industryType ? 'border-red-500' : 'border-gray-300'} focus-within:border-blue-500`}>
                    <div className="bg-gray-100 h-full">
                  ...
                  <div className={`mt-[5%] border rounded h-10 w-full flex relative items-center ${fieldsEmpty.password ? 'border-red-500' : 'border-gray-300'} focus-within:border-blue-500`}>
                    <div className="bg-gray-100 h-full">
                    ...
                    <div className="flex items-center cursor-pointer h-full ">
                      {/* <div className="flex items-center h-full w-full">
                       ...
                       <button className="hover:bg-gray-400 bg-gray-300 h-full w-full text-left px-2" onClick={() => generatePassword()}>
                ...
                <div className="flex flex-col w-[49%]">
                  <div className={`border rounded h-10 w-full flex relative items-center ${(!emailValid && email !== '') && 'border-red-500'} ${fieldsEmpty.email && 'border-red-500'} focus-within:border-blue-500`}>
                    <div className="bg-gray-100 h-full">
                  ...
                  <div className={`mt-[5%] border rounded h-10 w-full flex relative items-center ${fieldsEmpty.phone ? 'border-red-500' : 'border-gray-300'} focus-within:border-blue-500`}>
                  ...
                  <div className={`mt-[5%] border rounded h-10 w-full flex relative items-center ${fieldsEmpty.companyRegType ? 'border-red-500' : 'border-gray-300'} focus-within:border-blue-500`}>
                    <div className="border bg-gray-100 h-full">
                      <img className="h-full p-2" src='/factory.png' />
                    </div>
                    <input
                  ...
                  <div className={`mt-[5%] relative border rounded h-10 w-full flex items-center ${!passwordsMatch && 'border-red-500'} ${fieldsEmpty.cnfPass && 'border-red-500'} focus-within:border-blue-500`}>
                    <div className="border bg-gray-100 h-full">
                      <img className="h-full p-2" src='/password-key.png' />
                    </div>
                    <input
