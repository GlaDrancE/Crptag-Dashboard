  ...
  return (
    <div>
      <div className=" bg-white p-4 shadow-md rounded-lg">
        <div className="grid  grid-cols-1 lg:grid-cols-4 md:grid-cols-3 gap-4 mb-4">
          <input
        ...
        <div>
          <div className=" overflow-auto">
            <table className=" bg-white border w-[200%] rounded-lg">
              <thead className="bg-secondary/20 rounded-tl-lg rounded-tr-lg">
                <tr>
                  <th className="py-2 px-4 text-sm  border-b">Client Name</th>
                  <th className="py-2 px-4 text-sm  border-b">Client ID</th>
                  <th className="py-2 px-4 text-sm  border-b">UID</th>
                  <th className="py-2 px-4 text-sm  border-b">Batch Number</th>
                  <th className="py-2 px-4 text-sm  border-b">Tag Status</th>
                  <th className="py-2 px-4 text-sm border-b">
                    Tag Activated Date and Time
                  </th>
                  <th className="py-2 px-4 text-sm  border-b">Scan Count</th>
                  <th className="py-2 px-4 text-sm  border-b">
                    Last Scan Date and Time
                  </th>
                  <th className="py-2 px-4 text-sm  border-b">Frauds</th>
                  <th className="py-2 px-4 text-sm  border-b">
                    Blacklist Status
                  </th>
                  <th className="py-2 px-4 text-sm  border-b">Modify</th>
                  <th className="py-2 px-4 text-sm  border-b">Revoke</th>
                </tr>
              </thead>
              <tbody className="">
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded shadow-lg">
              ...
              <p className="mb-4">
                ...
                {selectedTag.tagstatus === "Active" ? "revoke" : "activate"}{" "}
                this tag?
              </p>
              <div className="flex justify-end">
                <button
